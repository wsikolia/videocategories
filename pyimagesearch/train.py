...
# We arre telling python where to find the datasets for analysis
# in the line below, we create a list which has all items in the 
# the directory and subdirectory in an alphabetical order
